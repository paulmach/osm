...
func (Relation_MemberType) EnumDescriptor() ([]byte, []int) { return fileDescriptorOsm, []int{9, 0} }
...
func (*OSM) Descriptor() ([]byte, []int) { return fileDescriptorOsm, []int{3} }
...
func (*Node) Descriptor() ([]byte, []int) { return fileDescriptorOsm, []int{4} }
...
func (*Info) Descriptor() ([]byte, []int) { return fileDescriptorOsm, []int{5} }
...
func (*DenseNodes) Descriptor() ([]byte, []int) { return fileDescriptorOsm, []int{6} }
...
func (*DenseInfo) Descriptor() ([]byte, []int) { return fileDescriptorOsm, []int{7} }
...
func (*Way) Descriptor() ([]byte, []int) { return fileDescriptorOsm, []int{8} }
...
func (*Relation) Descriptor() ([]byte, []int) { return fileDescriptorOsm, []int{9} }
...
func (m *Bounds) MarshalTo(data []byte) (int, error) {
	...
	if m.MinLng == nil {
		...
		data[i] = 0x8
		i++
		i = encodeVarintOsm(data, i, uint64((uint64(*m.MinLng)<<1)^uint64((*m.MinLng>>63))))
	}
	if m.MaxLng == nil {
		return 0, new(github_com_golang_protobuf_proto.RequiredNotSetError)
	} else {
		data[i] = 0x10
		i++
		i = encodeVarintOsm(data, i, uint64((uint64(*m.MaxLng)<<1)^uint64((*m.MaxLng>>63))))
	}
	if m.MinLat == nil {
		return 0, new(github_com_golang_protobuf_proto.RequiredNotSetError)
	} else {
...
func (m *Node) MarshalTo(data []byte) (int, error) {
	...
	if m.Lng == nil {
		...
		data[i] = 0x48
		i++
		i = encodeVarintOsm(data, i, uint64((uint64(*m.Lng)<<1)^uint64((*m.Lng>>63))))
	}
	if m.XXX_unrecognized != nil {
		i += copy(data[i:], m.XXX_unrecognized)
	}
...
func (m *DenseNodes) MarshalTo(data []byte) (int, error) {
	...
	if len(m.Lng) > 0 {
		var j25 int
		data27 := make([]byte, len(m.Lng)*10)
		for _, num := range m.Lng {
...
func (m *Bounds) Size() (n int) {
	...
	_ = l
	if m.MinLng != nil {
		n += 1 + sozOsm(uint64(*m.MinLng))
	}
	if m.MaxLng != nil {
		n += 1 + sozOsm(uint64(*m.MaxLng))
	}
	if m.MinLat != nil {
...
var fileDescriptorOsm = []byte{
	...
	,
}
